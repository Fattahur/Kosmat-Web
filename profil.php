...
<head>
    <meta charset="UTF-8">
    <title> Profil </title>
    <link rel="stylesheet" href="./css/prof.css" media="screen" title="no title">
        ...
        <div class="home-content">
            <div class="sales-boxes">
                <div class="recent-sales box">
                    <p class="judul">Edit Profil</p>
                    <form action="./php/update.php" method="post" id="form" autocomplete="off" enctype="multipart/form-data">
                        <div class="form-group NIK">
                            <label for="nik">NIK</label>
                            <input type="text" id="nik" name="nik" placeholder="Masukkan NIK Yang Telah Terdaftar"
                        ...
                        <div class="form-group telepon">
                            ...
                            value="<?php echo $_SESSION['no_whatsapp'] ?>">
                        </div>
                        <div class="form-group teleponwali">
                            <label for="alamat">Nomor Whatsapp (Wali)</label>
                            <input type="text" id="teleponwali" name="teleponwali" placeholder="Silahkan Masukkan Nomor Whatsapp (Wali) Anda"
                            value="<?php echo $_SESSION['no_whatsapp_wali'] ?>">
                        </div>
                        ...
                        <div class="form-group password">
                            ...
                            <input type="password" id="password" name="password" placeholder="Silahkan Masukkan Password"
                        ...
                        <div class="form-group date">
                            ...
                            value="<?php echo $_SESSION['tgl_lahir'] ?>">
                        </div>
                        ...
                        <input type="file" name="image" id="profilimage">
                        <a> Priview Foto Profil</a>
                        <img src="./img/" alt="" id="showimgprofil">
                        <input type="submit" name="simpan" class="btn_input" value="Simpan"></input>
                    </form>
                </div>
            </div>
    </section>
